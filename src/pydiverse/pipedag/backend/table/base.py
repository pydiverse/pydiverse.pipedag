...
class BaseTableStore(TableHookResolver, Disposable):
    ...
    def copy_table_to_transaction(self, table: Table, from_cache_slot: str):
        """Copy a table from a specific cache slot to the transaction stage

        This operation MUST not remove the table from the cache slot
    ...
    def copy_lazy_table_to_transaction(self, metadata: LazyTableMetadata, table: Table):
        ...
        This operation MUST not remove the table from the cache slot or modify
        it in any way.
