...
class BaseMaterializationDetails(ABC):
    ...
    def create_materialization_details_dict(
        ...
        materialization_details_cfg = materialization_details_cfg if materialization_details_cfg is not None else dict()
        ...
        if default_materialization_details and default_materialization_details not in materialization_details:
            raise ValueError(
                f"default_materialization_details {default_materialization_details} not in materialization_details"
            )
